...
/**
 * Reads and validates the audit config from a consuming repo. A missing file is not an error;
 * the Action is fully usable with no config file at all, scanning every ecosystem with the
 * default license classification.
 */
